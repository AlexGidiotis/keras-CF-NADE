...
def main(data_path, output, seed):
    ...
    ratings = read_ratings(os.path.join(data_path, 'ratings.dat'))[:100]
...
if __name__ == "__main__":
    ...
    main("/home/alex/Documents/Data/ml-1m",
         "/home/alex/Documents/git_projects/keras-CF-NADE/data/movielens1m-shuffle-itembased-1",
         2341)
    ...
    print '2'
    main("/home/alex/Documents/Data/ml-1m",
         "data/MovieLens1M-shuffle-itembased-2",
         3412)
    print '3'
    main("/home/alex/Documents/Data/ml-1m",
         "data/MovieLens1M-shuffle-itembased-3",
         4123)
    print '4'
    main("/home/alex/Documents/Data/ml-1m",
         "data/MovieLens1M-shuffle-itembased-4",
         1324)
    '''
